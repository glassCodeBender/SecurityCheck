...
class IntegrityCheck {
	...
	def main(args: Array[String]): Unit = {
		...
		val oldTreeMap = new mutable.TreeMap[String, String]   // this will be replaced by the HashMap generated by JSON.
		// MAYBE USE .filter() to filter new collection down to only files without a match!!!! (p. 290)
		val fileChanges = newTreeMap.filter( _ != oldTreeMap._) // this value will be passed to BigBrainSecurity.Scala
